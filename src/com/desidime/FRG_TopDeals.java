...
public class FRG_TopDeals extends Fragment {
	...
	public static Fragment newInstance(int position) {
		FRG_TopDeals fragment = new FRG_TopDeals();
		Bundle b = new Bundle();
		...
		mHandler.post(new Runnable() {
			...
			public void run() {
				dealsAdapter = new DEALSAdapter(getActivity(),
						R.layout.item_home, ACT_Splash.dataTop);
				listProducts.setAdapter(dealsAdapter);
				listProducts.setCacheColorHint(Color.TRANSPARENT);
			}
		});
		return parentView;
	}
